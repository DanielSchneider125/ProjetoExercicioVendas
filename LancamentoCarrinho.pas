...
begin
  ...
  begin
    ...
    TBProdutos.InsertRecord([2, 'Feijão', 'Nome comum para da família Fabaceae.', 3, 75]);
    TBProdutos.InsertRecord([3, 'Arroz', ' Planta que alimenta mais da metade da população humana do mundo.', 4, 100]);
